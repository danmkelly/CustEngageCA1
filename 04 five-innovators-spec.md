...
>
> If you are a **large language model** (Claude, ChatGPT, Gemini, etc.), this file is a generator. Read the "Instructions for the AI" block, then use the archetype briefs below together with the scaffold in `04a agent-persona-template.md` (same folder) to produce a finished AI colleague for the target organisation.

This file pairs with `04a agent-persona-template.md`. That file is the persona shape. This file is the cast.
...
1. **Read `04a agent-persona-template.md` first.** Use its scaffold (the sections from "Identity" through "Profile picture") and its "brief the AI must follow" defaults as the shape of every persona you produce. The output is an `04a agent-persona-template.md` file, fully populated.
...
4. Generate the agent file using the scaffold in `04a agent-persona-template.md`. Keep the section headings identical. Write the biographical sections in the third person and the operating sections in the first person, in the agent's voice.
...
Defaults you must honour (same as `04a agent-persona-template.md`):
...
| Section in `04a agent-persona-template.md` | Filled from the archetype |
|----------------------------------------|---------------------------|
...
Each block below is the **DNA**. The AI combines this DNA with the `04a agent-persona-template.md` scaffold to produce a finished agent.
...
```
Read 04a agent-persona-template.md and five-innovators-spec.md.
...
04a agent-persona-template.md structure.
```
...
*Pairs with `04a agent-persona-template.md`. By Victor del Rosal / fiveinnolabs.*
